...
// State of Leaving The Track (t,f -> true or false
char hasLeaveTheTrack = 'f';
...
void loop()
{
  ...
  // Hard turns for high offsets from 0
    ...
    hardTurnLeft();
      ...
      Serial.println("ROBOT HAS LEFT THE TRACK AND SEARCH THE WAY BACK, PLEASE COME TO CHECK THE SITUATION");
