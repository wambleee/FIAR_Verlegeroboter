...
double kp = 0.03; // old=0.3, 0.1 (best), 0.05
int turnoffset;
int lastturnoffset;
...
int minSpeed = 50;
int maxSpeed = 125;
int turnSpeed = 200; // last=180

void setup()
{
  // Start Serial Input and Output (for bluetooth)
  Serial.begin(9600);
  /*Serial.print("Linefollower initalized: Sensitivity=");
  Serial.print(lineFollowSensitivity);
  Serial.print(" and TurnThreshold=");
...
void loop()
{
  ...
  /*
  Serial.print("RGB1");
  Serial.println(RGBLineFollower.getADCValueRGB1());
  
  Serial.print("RGB2");
  Serial.println(RGBLineFollower.getADCValueRGB2());

  
  Serial.print("RGB3");
  Serial.println(RGBLineFollower.getADCValueRGB3());

  
  Serial.print("RGB4");
  Serial.println(RGBLineFollower.getADCValueRGB4());*/
  }
}
